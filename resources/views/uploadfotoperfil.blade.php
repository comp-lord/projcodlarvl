                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="center col-md-12 " style='height:50px;'>
                            <h3 class="text-danger">Perfil de {{$string_username[0]}}<?php echo '@'?>{{$string_username[1]}}</h3>
                        </div>
                        <div class = "row">
                            <div class="center col-xs-12 col-sm-12 col-md-12" style="height:200px">
                                <h5 class="text-primary">Fotografia de perfil</h5>
                                <div class="row">
                                    <img style="width:150px;height:150px;" class="img-responsive img-thumbnail" src="data:image/jpeg;base64,{{$perfil->fotografia}}" />
                                </div>
                                <form action="/uploadfotoperfil/do_upload" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <div class = "row">
                            <span class="col-sm-2 pull-right"><a href="/perfil" type="button" class="btn btn-primary">Feito</a></span>
                        </div>   
                    </div>
                </div>
            </div>
